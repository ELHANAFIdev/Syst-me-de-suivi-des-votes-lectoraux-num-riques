...
import { Lock, Mail, Loader2, LogIn, UserCircle2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans bg-[url('https://www.transparenttextures.com/patterns/cubes.png')]" dir="rtl">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="flex justify-center text-slate-800">
          <div className="p-3 bg-slate-200 rounded-2xl shadow-sm">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white/90 backdrop-blur-xl py-8 px-4 shadow-xl border border-white/40 sm:rounded-3xl sm:px-10 transition-all">
          
          {error && (
            <div className="mb-6 bg-red-50 border-r-4 border-red-500 p-4 rounded-xl shadow-sm">
            ...
            <div>
              ...
              <div className="mt-2 relative">
                ...
                <input
                  type="email"
                  required
                  className="appearance-none block w-full px-3 py-3 pr-10 border border-slate-300 rounded-xl shadow-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-slate-500 sm:text-sm transition-all"
